...
exports.run = async (bot, message, args) => {
    ...
    if (args[0] == 'aç') {
        ...
        message.channel.send(`Zaten reklam engel koruması açık kapatmak için +reklam-engel kapat`)
    }
    ...
    if (args[0] == 'kapat') {
        ...
        message.channel.send(`Zaten reklam engel koruması kapalı açmak için +reklam-engel aç` )
    }
